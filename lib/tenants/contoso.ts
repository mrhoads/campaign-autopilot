...
export const contosoTenant: Tenant = {
  ...
  prompts: {
    builderSample:
      "I want to build a Labor Day campaign for Contoso auto insurance focused on families and young professionals. I need paid social copy, email copy, a landing page concept, and 3 visual directions. Keep it family-friendly, modern, and trustworthy.",
    autopilotDefault:
      "Build me a Labor Day campaign for Contoso auto insurance focused on families and young professionals. I need paid social copy, email copy, a landing page concept, three visual directions, and a 12-second hero video for connected TV. Keep it family-friendly, modern, and trustworthy.",
    welcome:
